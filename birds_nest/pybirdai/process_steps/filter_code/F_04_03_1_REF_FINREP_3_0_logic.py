...
class F_04_03_1_REF_FINREP_3_0_UnionTable :
	...
	F_04_03_1_REF_FINREP_3_0_Other_loans_Table = None # Other_loans
	...
	def calc_F_04_03_1_REF_FINREP_3_0_UnionItems(self) -> list[F_04_03_1_REF_FINREP_3_0_UnionItem] :
		...
		for item in self.F_04_03_1_REF_FINREP_3_0_Other_loans_Table.Other_loanss:
...
class Other_loans(F_04_03_1_REF_FINREP_3_0_Base):
	CLLTRL = None # CLLTRL
	...
	@lineage(dependencies={"INSTRMNT_RL.LW_CRDT_RSK_INDCTR"})
	def LW_CRDT_RSK_INDCTR(self):
		return self.INSTRMNT_RL.LW_CRDT_RSK_INDCTR
	...
	@lineage(dependencies={"SCRTY_EXCHNG_TRDBL_DRVTV.LW_CRDT_RSK_INDCTR"})
	def LW_CRDT_RSK_INDCTR(self):
		return self.SCRTY_EXCHNG_TRDBL_DRVTV.LW_CRDT_RSK_INDCTR
...
class F_04_03_1_REF_FINREP_3_0_Other_loans_Table:
