...
class F_19_00_b_REF_FINREP_3_0_UnionTable :
	...
	F_19_00_b_REF_FINREP_3_0_Other_loans_Table = None # Other_loans
	F_19_00_b_REF_FINREP_3_0_On_demand_and_short_notice_Table = None # On_demand_and_short_notice
	...
	def calc_F_19_00_b_REF_FINREP_3_0_UnionItems(self) -> list[F_19_00_b_REF_FINREP_3_0_UnionItem] :
		...
		for item in self.F_19_00_b_REF_FINREP_3_0_Other_loans_Table.Other_loanss:
			newItem = F_19_00_b_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in self.F_19_00_b_REF_FINREP_3_0_On_demand_and_short_notice_Table.On_demand_and_short_notices:
			newItem = F_19_00_b_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
...
class Other_loans(F_19_00_b_REF_FINREP_3_0_Base):
	CLLTRL = None # CLLTRL
...
class On_demand_and_short_notice(F_19_00_b_REF_FINREP_3_0_Base):
	CRDT_FCLTY = None # CRDT_FCLTY
	@lineage(dependencies={"CRDT_FCLTY.DFLT_STTS"})
	def PRFRMNG_STTS(self):
		return self.CRDT_FCLTY.DFLT_STTS
...
class F_19_00_b_REF_FINREP_3_0_Other_loans_Table:
...
class F_19_00_b_REF_FINREP_3_0_On_demand_and_short_notice_Table:
	CRDT_FCLTY_Table = None # CRDT_FCLTY
	INSTRMNT_Table = None # INSTRMNT
	INSTRMNT_ENTTY_RL_ASSGNMNT_Table = None # INSTRMNT_ENTTY_RL_ASSGNMNT
	INSTRMNT_RL_Table = None # INSTRMNT_RL
