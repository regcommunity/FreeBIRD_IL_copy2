...
class F_13_01_REF_FINREP_3_0_Base:
	...
	def TYP_INSTRMNT() -> str:
		''' return string from TYP_INSTRMNT enumeration '''
		pass
	def CMMRCL_RL_ESTT_LN_INDCTR() -> str:
		''' return string from CMMRCL_RL_ESTT_LN_INDCTR enumeration '''
		pass
...
class F_13_01_REF_FINREP_3_0_UnionTable :
	...
	F_13_01_REF_FINREP_3_0_Other_loans_Table = None # Other_loans
	...
	def calc_F_13_01_REF_FINREP_3_0_UnionItems(self) -> list[F_13_01_REF_FINREP_3_0_UnionItem] :
		...
		for item in self.F_13_01_REF_FINREP_3_0_Other_loans_Table.Other_loanss:
...
class Other_loans(F_13_01_REF_FINREP_3_0_Base):
	CLLTRL = None # CLLTRL
	...
	@lineage(dependencies={"INSTRMNT.CMMRCL_RL_ESTT_LN_INDCTR"})
	def CMMRCL_RL_ESTT_LN_INDCTR(self):
		return self.INSTRMNT.CMMRCL_RL_ESTT_LN_INDCTR
...
class F_13_01_REF_FINREP_3_0_Other_loans_Table:
